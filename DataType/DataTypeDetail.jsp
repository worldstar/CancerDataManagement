...
function deleteOnClick(_address){
	...
	$( "#dialog-confirm" ).dialog( "open" );
		...
		<a href="DataTypeUpdate.jsp?DataTypeID=<%=DataTypeID%>"><img src="../images/modify_btn.png" width="95" height="34" /></a>
		<a href="#" onclick="deleteOnClick('DataTypeDelete.jsp?DataTypeID=<%=DataTypeID%>')"><img src="../images/delete_btn.png" width="95" height="34" /></a><!-- InstanceEndEditable -->
