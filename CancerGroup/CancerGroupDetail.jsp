...
PreparedStatement StatementRecordset1 = ConnRecordset1.prepareStatement("SELECT * FROM CancerGroup, UsersTable where CancerGroupID = ? and CancerGroup.UserID=UsersTable.UserID", ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
StatementRecordset1.setString(1, CancerGroupID);
...
function deleteOnClick(_address){
	...
	$( "#dialog-confirm" ).dialog( "open" );
		...
		<a href="CancerGroupUpdate.jsp?CancerGroupID=<%=CancerGroupID%>"><img src="../images/modify_btn.png" width="95" height="34" /></a>
		<a href="#" onclick="deleteOnClick('CancerGroupDelete.jsp?CancerGroupID=<%=CancerGroupID%>')"><img src="../images/delete_btn.png" width="95" height="34" /></a><!-- InstanceEndEditable -->
