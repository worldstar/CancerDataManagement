...
<%
    ...
    PreparedStatement StatementRecordset1 = ConnRecordset1.prepareStatement("SELECT * FROM CancerPart where CancerPartID = ?", ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
