...
PreparedStatement StatementRecordset1 = ConnRecordset1.prepareStatement("SELECT * FROM UsersTable where UserID = ? ", ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
...
function deleteOnClick(_address){
	...
	$( "#dialog-confirm" ).dialog( "open" );
		...
		<a href="UsersTableUpdate.jsp?UserID=<%=UserID%>"><img src="../images/modify_btn.png" width="95" height="34" /></a>
		<a href="#" onclick="deleteOnClick('UsersTableDelete.jsp?UserID=<%=UserID%>')"><img src="../images/delete_btn.png" width="95" height="34" /></a><!-- InstanceEndEditable -->
