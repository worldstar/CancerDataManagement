...
<%
    ...
    PreparedStatement StatementRecordset1 = ConnRecordset1.prepareStatement("SELECT * FROM CancerGroup where CancerGroupID = ?", ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
