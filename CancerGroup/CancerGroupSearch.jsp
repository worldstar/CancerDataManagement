...
<tr>
				...
				<td><a href='CancerGroupUpdate.jsp?CancerGroupID=<%=Recordset1.getObject("CancerGroupID") %>'>Update</a> <a href='CancerGroupDelete.jsp?CancerGroupID=<%=Recordset1.getObject("CancerGroupID") %>'>Delete</a></td>
</tr>
...
%>
    ...
    <div align="center">
      <label></label>
      <%=pageIndex1.traverseBar("CancerGroupSearch.jsp", "startRecord", totalRecords, showRecords, start, SearchContent) %>
    </div>
    </label>
    <a href="CancerGroupInput.jsp"><img src="../images/add_btn.png" width="95" height="34" /></a><a href="#"><img src="../images/BackC_btn.png" alt="" width="95" height="34" onclick="window.history.back();" /></a>        
