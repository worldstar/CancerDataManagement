...
%>
<%
    String sql = "insert into Diagnosis (DiagnosisName,PatientsID,CancerPartID,StatisticID,DataTypeID,SequenceNumber,Histology,BehaviorCode,Differentiation,TumorSize,cT,cN,cM,cStage,Recurrence,VitalStatus,createdDate,UserID) values ( ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ?)";
