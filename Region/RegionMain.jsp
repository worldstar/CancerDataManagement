...
<%
	...
	if(request.getParameter("startRecord") != null){//First entry		
        ...
        ConnRecordset1.prepareStatement("SELECT count(*) FROM Region");  
        ResultSet CountRecordset1 = preCountStatement.executeQuery();
        CountRecordset1.next();
        totalRecords = CountRecordset1.getInt(1);                
    }    
	
PreparedStatement StatementRecordset1 = ConnRecordset1.prepareStatement("SELECT * FROM Region, Users where Region.UserID=Users.UserID order by SexTypeID desc limit "+start+","+showRecords+"; ");


if(dbServerProduct.equals("SQLServer2012")){
  StatementRecordset1 = ConnRecordset1.prepareStatement("SELECT * FROM Region, Users where Region.UserID=Users.UserID order by SexTypeID desc OFFSET  "+start+" ROWS FETCH NEXT "+showRecords+" ROWS ONLY;");
}
else if(dbServerProduct.equals("SQLServer2008")){
  StatementRecordset1 = ConnRecordset1.prepareStatement("SELECT * FROM (SELECT ROW_NUMBER() OVER ( ORDER BY SexTypeID ) AS RowNum, * FROM Region, Users where Region.UserID=Users.UserID) AS RowConstrainedResult where RowNum >= "+start+" and RowNum < "+(start+showRecords)+" ORDER BY RowNum; ");
}
...
<H2>Region</H2>
<a href="RegionInput.jsp"><img src="../images/add_btn.png" alt="" width="95" height="34" align="left" /></a>

<div align="center">
      <form action="RegionSearch.jsp" method="post" id="form1">
...
%>
    ...
    <div align="center">
      <label></label>
      <%=pageIndex1.traverseBar("RegionMain.jsp", "startRecord", totalRecords, showRecords, start) %>
    </div>
    </label>
    <a href="RegionInput.jsp"><img src="../images/add_btn.png" width="95" height="34" /></a>    
