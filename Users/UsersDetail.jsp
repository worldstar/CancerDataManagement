...
function deleteOnClick(_address){
	...
	$( "#dialog-confirm" ).dialog( "open" );
		...
		<a href="UsersUpdate.jsp?UserID=<%=UserID%>"><img src="../images/modify_btn.png" width="95" height="34" /></a>
		<a href="#" onclick="deleteOnClick('UsersDelete.jsp?UserID=<%=UserID%>')"><img src="../images/delete_btn.png" width="95" height="34" /></a><!-- InstanceEndEditable -->
