...
<%
    ...
    PreparedStatement StatementRecordset1 = ConnRecordset1.prepareStatement("SELECT * FROM DataType where DataTypeID = ?", ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
