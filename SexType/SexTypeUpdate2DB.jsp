...
<%
    String sql = "update SexType set SexTypeName = ?, createdDate = ?, UserID = ? where SexTypeID = ?";
    String sessionUpdateID = (String) session.getAttribute("SexTypeUpdateID");
    ...
    response.sendRedirect("SexTypeMain.jsp");      
%>
