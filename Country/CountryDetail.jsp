...
function deleteOnClick(_address){
	...
	$( "#dialog-confirm" ).dialog( "open" );
		...
		<a href="CountryUpdate.jsp?CountryID=<%=CountryID%>"><img src="../images/modify_btn.png" width="95" height="34" /></a>
		<a href="#" onclick="deleteOnClick('CountryDelete.jsp?CountryID=<%=CountryID%>')"><img src="../images/delete_btn.png" width="95" height="34" /></a><!-- InstanceEndEditable -->
