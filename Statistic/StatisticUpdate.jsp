...
<h2>Statistic</h2>
    <form id="form1" name="form1" method="post" action="StatisticUpdate2DB.jsp">
...
%>          <tr>
            <td>StatisticName*</td>
           <td><input name="StatisticName" type="text" id="StatisticName" size="30" value="<%=Recordset1.getObject("StatisticName")%>" /></td>
           </tr>
...
<%
	session.setAttribute("StatisticUpdateID", StatisticID);
