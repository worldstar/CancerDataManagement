...
<%
    ...
    PreparedStatement StatementRecordset1 = ConnRecordset1.prepareStatement("SELECT * FROM Country where CountryID = ?", ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
