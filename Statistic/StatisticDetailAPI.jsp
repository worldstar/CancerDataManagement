...
<%
    ...
    PreparedStatement StatementRecordset1 = ConnRecordset1.prepareStatement("SELECT * FROM Statistic where StatisticID = ?", ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
