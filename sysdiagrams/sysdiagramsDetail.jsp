...
function deleteOnClick(_address){
	...
	$( "#dialog-confirm" ).dialog( "open" );
		...
		<a href="sysdiagramsUpdate.jsp?name=<%=name%>"><img src="../images/modify_btn.png" width="95" height="34" /></a>
		<a href="#" onclick="deleteOnClick('sysdiagramsDelete.jsp?name=<%=name%>')"><img src="../images/delete_btn.png" width="95" height="34" /></a><!-- InstanceEndEditable -->
