...
<h2>CancerGroup</h2>
    <form id="form1" name="form1" method="post" action="CancerGroupUpdate2DB.jsp">
...
%>          <tr>
           ...
           <td><input name="CancerGroupName" type="text" id="CancerGroupName" size="30" value="<%=Recordset1.getObject("CancerGroupName")%>" /></td>
           </tr>
...
<%
	session.setAttribute("CancerGroupUpdateID", CancerGroupID);
