...
<%
    String sql = "update Statistic set StatisticName = ?, createdDate = ?, UserID = ? where StatisticID = ?";
    String sessionUpdateID = (String) session.getAttribute("StatisticUpdateID");
